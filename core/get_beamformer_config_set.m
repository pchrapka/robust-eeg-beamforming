...
switch name
    ...
    case 'sim_vars_mult_src_eig_variations_mismatched'
        ...
        out.beamformer_config = {...
            ...
            {'BeamformerLCMV','regularization','eig'},...
            {'BeamformerLCMV','pinv',true},...
            {'BeamformerLCMV','pinv',true,'eig_type','eig filter','ninterference',0},...
            {'BeamformerLCMV','pinv',true,'eig_type','eig filter','ninterference',1},...
            {'BeamformerLCMV','pinv',true,'eig_type','eig cov','ninterference',0},...
            {'BeamformerLCMV','pinv',true,'eig_type','eig cov','ninterference',1},...
            {'BeamformerLCMV','pinv',true,'regularization','eig'}};
