...
switch name
    ...
    case 'sim_vars_mult_src_paper_matched'
        ...
        out.beamformer_config = {...
            ...
            {'BeamformerLoreta', 'regularization','eig'},...
            {'BeamformerLCMV'},...
            ...{'BeamformerLCMV','eig_type','eig cov','ninterference',0},...
    ...
    case 'sim_vars_mult_src_paper_mismatched'
        ...
        out.beamformer_config = {...
            ...
            {'BeamformerRMV','aniso',true},...
            {'BeamformerRMV','aniso',true,'aniso_mode','normal','c',500,'multiplier',0.4},...
            ...{'BeamformerRMV','aniso',true,'eig_type','eig pre cov','ninterference',0},...
    ...
    case 'sim_vars_mult_src_paper_mismatched_sensitivity_normal'
        ...
        mult_vals = [0.1 0.15 0.2 0.25 0.3 0.35 0.4 0.6];
        count = 1;
        for k=1:length(mult_vals)
            out.beamformer_config{count} = {'BeamformerRMV',...
                'aniso',true,'aniso_mode','normal','c',500,'multiplier',mult_vals(k)};
            count = count + 1;
        end
