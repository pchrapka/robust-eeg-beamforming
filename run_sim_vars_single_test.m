%% run_sim_vars_single_test.m -- Script for running different analysis variations 
...
cfg = struct(...
    ...
    'sim_src_parameters',   'src_param_single_cortical_source_2');
scripts(k).vars = {cfg};
k = k+1;
...
cfg_data.source_name = 'single_cort_src_2';
...
cfg_simvars_setup = [];
cfg_simvars_setup.id = 'sim_vars_mult_src_basic_matched';
