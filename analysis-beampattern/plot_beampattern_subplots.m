function plot_beampattern_subplots(cfg)
%PLOT_BEAMPATTERN_SUBPLOTS plots 1D beampattern data
%   PLOT_BEAMPATTERN_SUBPLOTS plots beampattern data against the distance
