%% run_sim_vars_bem_paper_covtrial_mult17.m
%
%   Summary:
%   - multiple source
%   - uses trial covariance
...
cfg = struct(...
    'sim_data',             'sim_data_bem_1_1000t_noavg',...
    'sim_src_parameters',   'src_param_mult_cortical_source_17_randamp',...
    'snr_range',            -20:5:20,...
...
data_files = get_sim_data_files(...
    'sim','sim_data_bem_1_1000t_noavg',...
    'source','mult_cort_src_17_randamp',...
    'iterations',1,...
    'snr',-20:5:20 ...
    ...'snr',0 ...
    );
