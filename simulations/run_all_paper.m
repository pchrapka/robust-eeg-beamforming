...
flag_section_snr = false;
flag_section_beampattern = false;
flag_section_power = true;
...
if flag_section_power
    ...
    compute_localization_error_bemhd_config_paper(...
        sim_file,source_name,...
        'datatag','locsall_covtrial_s1-250',...
        'PlotGroups',{'matched-power','mismatched-power'},...
        'snr',snr_power);
    
    compute_fwhm_bemhd_config_paper(...
        sim_file,source_name,...
        'datatag','locsall_covtrial_s1-250',...
        'PlotGroups',{'matched-power','mismatched-power'},...
        'snr',snr_power);
