...
metric_analysis_sinr_mult('sim_data_bem_1_100t', 'mult_cort_src_sine_2');
metric_analysis_sinr_mult('sim_data_bem_1_100t', 'mult_cort_src_17_lag40');
metric_analysis_sinr_mult('sim_data_bem_1_100t', 'mult_cort_src_sine_2_uncor');
