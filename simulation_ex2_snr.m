%% simulation_ex2_snr.m -- Example 2: Mismatched leadfield matrix
% Performs an analysis of the robust beamformer for a mismatched leadfield
% matrix over varying values of SNR. The mismatched leadfield matrix is
...
function simulation_ex2_snr(varargin)
...
%                     lambda_cfg);
                  beam_cfg(k).lambda = 10*sim_cfg.noise_power;
            end
