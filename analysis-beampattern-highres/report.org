#+TITLE:     Beamforming with the Muse
#+AUTHOR:    Phil Chrapka
...
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_lcmv_beampattern_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_lcmv_beampattern3d_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_lcmv_3sphere_beampattern_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_lcmv_3sphere_beampattern3d_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
\\
...
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_lcmv_reg_eig_beampattern_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_lcmv_reg_eig_beampattern3d_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_lcmv_reg_eig_3sphere_beampattern_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_lcmv_reg_eig_3sphere_beampattern3d_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
\\
...
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_lcmv_eig_1_beampattern_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_lcmv_eig_1_beampattern3d_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_lcmv_eig_1_3sphere_beampattern_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_lcmv_eig_1_3sphere_beampattern3d_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
\\
...
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_rmv_epsilon_50_beampattern_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_rmv_epsilon_50_beampattern3d_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_rmv_epsilon_150_3sphere_beampattern_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_rmv_epsilon_150_3sphere_beampattern3d_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
\\
...
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_rmv_aniso_3sphere_beampattern_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
&
\begin{subfigure}[h]{0.2\textwidth}
     \includegraphics[width=\textwidth]{mult_cort_src_17hd/img/0_1_rmv_aniso_3sphere_beampattern3d_mmabsolute}
     %\caption{}
     %\label{fig:}
\end{subfigure}% 
\\
