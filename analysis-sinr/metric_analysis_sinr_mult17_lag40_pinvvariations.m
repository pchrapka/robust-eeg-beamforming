...
params(k).beamformer_configs = {...
    'lcmv_locs2_3sphere',...
    'lcmv_pinv_locs2_3sphere',...
    'lcmv_reg_eig_locs2_3sphere',...
    'lcmv_pinv_reg_eig_locs2_3sphere',...
    };
...
params(k).beamformer_configs = {...
    'lcmv_eig_cov_0_locs2_3sphere',...
    'lcmv_eig_cov_1_locs2_3sphere',...
    'lcmv_pinv_eig_cov_0_locs2_3sphere',...
    'lcmv_pinv_eig_cov_1_locs2_3sphere',...
    };
...
params(k).beamformer_configs = {...
    'lcmv_eig_filter_0_locs2_3sphere',...
    'lcmv_eig_filter_1_locs2_3sphere',...
    'lcmv_pinv_eig_filter_0_locs2_3sphere',...
    'lcmv_pinv_eig_filter_1_locs2_3sphere',...
    };
